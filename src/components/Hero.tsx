...
const Hero = ({ offset }: Props) => {
  ...
  return (
    <div className="justify-center bg-cover bg-[url('./assets/img/hero/md-bg.png')] lg:bg-none pb-[50px] lg:pb-[0px]" id="home">
      <div className="flex justify-center font-['Trouble_Font'] text-[64px] lg:text-[200px] mt-[-60px] pt-[20px] lg:mt-[-30px] tracking-[3px] leading-[240px] min-h-[200px] mb-[30px]"><img src={PulseChainArtOnlyTextBlackBg} alt="text" className="w-[80%]" /></div>
