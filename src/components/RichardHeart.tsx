...
const RichardHeart = () => {
  return (
    <div className="justify-center mt-0 lg:mt-10" id="richard heart">
      <div className="flex justify-center font-['Trouble_Font'] text-[64px] lg:text-[90px] tracking-[1px] leading-[120px]">About</div>
